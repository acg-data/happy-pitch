...
const industryData: Record<string, IndustryData> = {
  pharma: {
    ...
    howWeHelpTitle: 'How We Help Pharma Companies',
    whyChooseTitle: 'Why Pharma Companies Choose Us',
  },
  biotech: {
    title: 'Biotech',
    ...
    howWeHelpTitle: 'How We Help Biotech Companies',
    whyChooseTitle: 'Why Biotech Companies Choose Us',
  },
  'private-equity': {
    ...
    howWeHelpTitle: 'How We Help Private Equity Firms',
    whyChooseTitle: 'Why Private Equity Firms Choose Us',
  },
  'private-credit': {
    ...
    howWeHelpTitle: 'How We Help Private Credit Managers',
    whyChooseTitle: 'Why Private Credit Managers Choose Us',
  },
  'venture-capital': {
    ...
    howWeHelpTitle: 'How We Help Venture Capital Firms',
    whyChooseTitle: 'Why VC Firms Choose Us',
  },
  'family-office': {
    title: 'Family Office',
    ...
    howWeHelpTitle: 'How We Help Family Offices',
    whyChooseTitle: 'Why Family Offices Choose Us',
  },
  'digital-transformation': {
    ...
    howWeHelpTitle: 'How We Help Digital Transformation Companies',
    whyChooseTitle: 'Why DX Companies Choose Us',
  },
  'food-beverages': {
    ...
    howWeHelpTitle: 'How We Help Food & Beverage Companies',
    whyChooseTitle: 'Why F&B Companies Choose Us',
  },
  saas: {
    title: 'SaaS',
    ...
    howWeHelpTitle: 'How We Help SaaS Companies',
    whyChooseTitle: 'Why SaaS Companies Choose Us',
  },
  cpg: {
    title: 'CPG',
    ...
    howWeHelpTitle: 'How We Help CPG Companies',
    whyChooseTitle: 'Why CPG Companies Choose Us',
  },
};
...
export default function IndustryPage({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* How We Help */}
      <HowWeHelp 
        title={industry.howWeHelpTitle}
        subtitle={`Our proven process for ${industry.title.toLowerCase()} companies, designed to deliver exceptional results.`}
      />
      ...
      {/* Why Choose Us */}
      <WhyChooseUs 
        title={industry.whyChooseTitle}
        subtitle={`What sets us apart when working with ${industry.title.toLowerCase()} companies.`}
      />
